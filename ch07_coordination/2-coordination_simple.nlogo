;; A very simple coordination model. Everyone starts with one of two norms.
...
"" ""
PENS
"Freq Norm 1" 1.0 0 -7171555 true "" "plot (count turtles with [norm1?]) / (count turtles)"
...
* Smaldino PE (2023). Coordination: Simple. Modeling Social Behavior.  https://github.com/psmaldino/modsoc/
...
<experiments>
  <experiment name="experiment" repetitions="100" runMetricsEveryStep="false">
    ...
    <metric>count turtles with [norm1?]</metric>
    <enumeratedValueSet variable="num-turtles">
      <value value="1000"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="conformist?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="copy-number">
      <value value="6"/>
    </enumeratedValueSet>
    <steppedValueSet variable="init-norm1" first="0.4" step="0.01" last="0.6"/>
    <enumeratedValueSet variable="alpha">
      <value value="0.5"/>
      <value value="1"/>
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="coordination-benefit">
      <value value="1"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="winner" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>freq-norm1</metric>
    <steppedValueSet variable="init-norm1" first="0.3" step="0.01" last="0.7"/>
    <enumeratedValueSet variable="coordination-benefit">
      <value value="1"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="experiment" repetitions="3" runMetricsEveryStep="false">
    ...
    <enumeratedValueSet variable="init-norm1">
      <value value="0.5"/>
    </enumeratedValueSet>
    <steppedValueSet variable="coordination-benefit" first="0" step="0.1" last="5"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
