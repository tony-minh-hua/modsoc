...
333
496
Degree Distribution (log-log) (first 500)
log(degree)
log(# of nodes)
0.0
0.3
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "if not plot? [ stop ]\nlet max-degree max [count link-neighbors] of turtles with [who > 500]\nplot-pen-reset  ;; erase what we plotted before\nset-plot-x-range 1 (max-degree + 1)  ;; + 1 to make room for the width of the last bar\nhistogram [count link-neighbors] of turtles with [who > 500]"
...
660
497
Degree Distribution (log-log) (next 500)
NIL
NIL
0.0
10.0
