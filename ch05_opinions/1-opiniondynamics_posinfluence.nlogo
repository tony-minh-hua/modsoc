...
to go
  ;; random agent chooses random neighbor or completely random neighbor
  ifelse (spatial-interactions)
  [interact-neighbor-turtle]
  [interact-random-turtle]
...
to interact-random-turtle
  ask one-of turtles [
    ...
    ;;Everyone becomes more similar to their partner
...
to interact-neighbor-turtle
  ask turtles-on one-of patches [
    let x1 opinion ;;my opinion
    let other-turtle one-of turtles-on neighbors4 ;;choose one interaction partner from neighbors at random
    let x2 [opinion] of other-turtle ;;other guy's opinion
